...
The `images/` folder in this repo currently contains only a README — the
real logo, certificate, unit, product and machinery photos still need to be
committed. `images/README.md` lists every expected filename. Pages degrade
gracefully (named placeholder panels) until the files arrive.
